...
export const CardGrid = () => {
  ...
  let prices = {
   ...
   let ids = {
    ...
    let img2 = {
      img21 :cld.image(`${imageIdArray[55][0]}`), 
      img22 :cld.image(`${imageIdArray[55][1]}`), 
      img23 :cld.image(`${imageIdArray[55][2]}`), 
      img24 :cld.image(`${imageIdArray[55][3]}`), 
      img25 :cld.image(`${imageIdArray[55][4]}`), 
      img26 :cld.image(`${imageIdArray[55][5]}`), 
...
const onClickNextPage = ({target})=>{
  ...
  if(target.name === 'next'){
    ...
    for(i=6; i<imageIdArray[0].length; i++){
      ...
      newImg2.push(imageIdArray[55][i])
    }
...
<> 
          ...
          {/* filter */}
          {
            (imageIdArray[55][0])
                    ...
                    <div className="form-floating form-control filter-custom filters-font card">
      ...
      
      {
            (imageIdArray[0][5] && imageIdArray[0][6])
                    ?  <a href="#up"><div className='text-center m-3 mb-5'><button onClick={onClickNextPage} name = 'next' type="button" className="btn btn-success btn-lg text-center"> VER MÁS </button></div></a>
                    :  <a href="#up"><div className='text-center m-3 mb-5'><button onClick={onClickNextPage} name = 'prev' type="button" className="btn btn-success btn-lg text-center"> VER MÁS </button></div></a>
          }
